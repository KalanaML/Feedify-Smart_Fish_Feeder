...
| :---: | :---: |
| ![Frontside](images/Frontside%20.jpeg) | ![Final Setup](images/Final%20Setup.png) |
...
* **Sensors:** * pH Sensor (Analog) - Water acidity monitoring
...
| :--- | :--- | :--- | :--- |
| **IT25103932** | Gamage K. T. | Hardware Design | Feeder mechanism design, Servo calibration for dynamic feeding, and physical assembly. |
| **IT25103933** | Wakishta N. N. | pH Monitoring | pH sensor integration, calibration, and local display logic. |
| **IT25103934** | Ramanayake N. R. D. M. | Thermal Systems | Temperature data processing and OLED UI implementation. |
| **IT25103935** | Anjana S. A. D. | Mobile IoT Development | Blynk Mobile app design (including fish profile inputs) and status LED logic. |
| **IT25103936** | Nirmala S. G. R. S. | Software Architecture | Implementing the dynamic portion calculation algorithm and web dashboard. |
...
* **Solar Integration:** Add a solar charging controller for off-grid pond use.
